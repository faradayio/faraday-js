...
export function ConnectionOptionsSqlServerPutFromJSON(json: any): ConnectionOptionsSqlServerPut {
    return ConnectionOptionsSqlServerPutFromJSONTyped(json, false);
}

export function ConnectionOptionsSqlServerPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsSqlServerPut {
...
export function ConnectionOptionsSqlServerPutToJSON(value?: ConnectionOptionsSqlServerPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
