...
export function TargetOptionsS3CsvPostFromJSON(json: any): TargetOptionsS3CsvPost {
    return TargetOptionsS3CsvPostFromJSONTyped(json, false);
}

export function TargetOptionsS3CsvPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetOptionsS3CsvPost {
...
export function TargetOptionsS3CsvPostToJSON(value?: TargetOptionsS3CsvPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
