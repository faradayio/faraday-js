...
export function ConnectionOptionsMysqlFromJSON(json: any): ConnectionOptionsMysql {
    return ConnectionOptionsMysqlFromJSONTyped(json, false);
}

export function ConnectionOptionsMysqlFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsMysql {
...
export function ConnectionOptionsMysqlToJSON(value?: ConnectionOptionsMysql | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
