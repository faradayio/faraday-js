...
export function OutcomeBiasMitigationStrategyFromJSON(json: any): OutcomeBiasMitigationStrategy {
    return OutcomeBiasMitigationStrategyFromJSONTyped(json, false);
}

export function OutcomeBiasMitigationStrategyFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutcomeBiasMitigationStrategy {
    return json as OutcomeBiasMitigationStrategy;
}

export function OutcomeBiasMitigationStrategyToJSON(value?: OutcomeBiasMitigationStrategy | null): any {
    return value as any;
}
