...
export function OutcomeAnalysisBiasSummaryFromJSON(json: any): OutcomeAnalysisBiasSummary {
    return OutcomeAnalysisBiasSummaryFromJSONTyped(json, false);
}

export function OutcomeAnalysisBiasSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutcomeAnalysisBiasSummary {
...
export function OutcomeAnalysisBiasSummaryToJSON(value?: OutcomeAnalysisBiasSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
