...
import {
    ...
    TargetLimitPutToJSON,
} from './TargetLimitPut';
import {
    TargetModesPut,
    TargetModesPutFromJSON,
    TargetModesPutFromJSONTyped,
    TargetModesPutToJSON,
} from './TargetModesPut';
import {
    TargetOptionsPut,
...
export function TargetPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetPut {
    ...
    return {
        ...
        'representation': TargetModesPutFromJSON(json['representation']),
    };
}
...
export function TargetPutToJSON(value?: TargetPut | null): any {
    ...
    return {
        ...
        'representation': TargetModesPutToJSON(value.representation),
    };
}
