...
export function ConnectionOptionsAwsAuroraPostgresPostFromJSON(json: any): ConnectionOptionsAwsAuroraPostgresPost {
    return ConnectionOptionsAwsAuroraPostgresPostFromJSONTyped(json, false);
}

export function ConnectionOptionsAwsAuroraPostgresPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsAwsAuroraPostgresPost {
...
export function ConnectionOptionsAwsAuroraPostgresPostToJSON(value?: ConnectionOptionsAwsAuroraPostgresPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
