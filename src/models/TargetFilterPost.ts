...
export function TargetFilterPostFromJSON(json: any): TargetFilterPost {
    return TargetFilterPostFromJSONTyped(json, false);
}

export function TargetFilterPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetFilterPost {
...
export function TargetFilterPostToJSON(value?: TargetFilterPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
