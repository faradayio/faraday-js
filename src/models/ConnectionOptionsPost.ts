...
import {
    ...
    ConnectionOptionsMergePostFromJSON,
    ConnectionOptionsMergePostFromJSONTyped,
    ConnectionOptionsMergePostToJSON,
} from './ConnectionOptionsMergePost';
import {
...
export function ConnectionOptionsPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsPost {
    ...
    switch (json['type']) {
        ...
        case 'merge':
            return {...ConnectionOptionsMergePostFromJSONTyped(json, true), type: 'merge'};
        case 'mysql':
...
export function ConnectionOptionsPostToJSON(value?: ConnectionOptionsPost | null): any {
    ...
    switch (value['type']) {
        ...
        case 'merge':
            return ConnectionOptionsMergePostToJSON(value);
        case 'mysql':
