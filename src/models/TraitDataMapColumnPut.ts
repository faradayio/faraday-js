...
export function TraitDataMapColumnPutFromJSON(
  json: any
): TraitDataMapColumnPut {
  return TraitDataMapColumnPutFromJSONTyped(json, false);
}

export function TraitDataMapColumnPutFromJSONTyped(
  json: any,
...
export function TraitDataMapColumnPutToJSON(
  value?: TraitDataMapColumnPut | null
): any {
  if (value === undefined) {
    return undefined;
  }
