...
export function CohortStreamConditionFromJSON(json: any): CohortStreamCondition {
    return CohortStreamConditionFromJSONTyped(json, false);
}

export function CohortStreamConditionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CohortStreamCondition {
...
export function CohortStreamConditionToJSON(value?: CohortStreamCondition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
