...
export function ConnectionOptionsAwsRdsSqlServerFromJSON(json: any): ConnectionOptionsAwsRdsSqlServer {
    return ConnectionOptionsAwsRdsSqlServerFromJSONTyped(json, false);
}

export function ConnectionOptionsAwsRdsSqlServerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsAwsRdsSqlServer {
...
export function ConnectionOptionsAwsRdsSqlServerToJSON(value?: ConnectionOptionsAwsRdsSqlServer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
