...
export function ConnectionOptionsAwsRdsPostgresPostFromJSON(json: any): ConnectionOptionsAwsRdsPostgresPost {
    return ConnectionOptionsAwsRdsPostgresPostFromJSONTyped(json, false);
}

export function ConnectionOptionsAwsRdsPostgresPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsAwsRdsPostgresPost {
...
export function ConnectionOptionsAwsRdsPostgresPostToJSON(value?: ConnectionOptionsAwsRdsPostgresPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
