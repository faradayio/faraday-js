...
export function ConnectionOptionsSegmentPutFromJSON(json: any): ConnectionOptionsSegmentPut {
    return ConnectionOptionsSegmentPutFromJSONTyped(json, false);
}

export function ConnectionOptionsSegmentPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsSegmentPut {
...
export function ConnectionOptionsSegmentPutToJSON(value?: ConnectionOptionsSegmentPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
