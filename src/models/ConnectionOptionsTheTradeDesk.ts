...
export function ConnectionOptionsTheTradeDeskFromJSON(json: any): ConnectionOptionsTheTradeDesk {
    return ConnectionOptionsTheTradeDeskFromJSONTyped(json, false);
}

export function ConnectionOptionsTheTradeDeskFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsTheTradeDesk {
...
export function ConnectionOptionsTheTradeDeskToJSON(value?: ConnectionOptionsTheTradeDesk | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
