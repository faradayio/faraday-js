...
export function ConnectionOptionsSftpPostFromJSON(json: any): ConnectionOptionsSftpPost {
    return ConnectionOptionsSftpPostFromJSONTyped(json, false);
}

export function ConnectionOptionsSftpPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsSftpPost {
...
export function ConnectionOptionsSftpPostToJSON(value?: ConnectionOptionsSftpPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
