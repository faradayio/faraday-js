...
export function TraitDataMapColumnFromJSONTyped(json: any, ignoreDiscriminator: boolean): TraitDataMapColumn {
...
export function TraitDataMapColumnToJSON(value?: TraitDataMapColumn | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
