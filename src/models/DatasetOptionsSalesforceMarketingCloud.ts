...
export function DatasetOptionsSalesforceMarketingCloudFromJSON(json: any): DatasetOptionsSalesforceMarketingCloud {
    return DatasetOptionsSalesforceMarketingCloudFromJSONTyped(json, false);
}

export function DatasetOptionsSalesforceMarketingCloudFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsSalesforceMarketingCloud {
...
export function DatasetOptionsSalesforceMarketingCloudToJSON(value?: DatasetOptionsSalesforceMarketingCloud | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
