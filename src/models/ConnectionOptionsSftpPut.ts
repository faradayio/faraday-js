...
export function ConnectionOptionsSftpPutFromJSON(json: any): ConnectionOptionsSftpPut {
    return ConnectionOptionsSftpPutFromJSONTyped(json, false);
}

export function ConnectionOptionsSftpPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsSftpPut {
...
export function ConnectionOptionsSftpPutToJSON(value?: ConnectionOptionsSftpPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
