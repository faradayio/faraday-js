...
import {
    ...
    DatasetOptionsMergeMergePatchFromJSON,
    DatasetOptionsMergeMergePatchFromJSONTyped,
    DatasetOptionsMergeMergePatchToJSON,
} from './DatasetOptionsMergeMergePatch';
import {
...
export function DatasetOptionsMergePatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsMergePatch {
    ...
    switch (json['type']) {
        ...
        case 'merge':
            return {...DatasetOptionsMergeMergePatchFromJSONTyped(json, true), type: 'merge'};
        case 'mysql':
...
export function DatasetOptionsMergePatchToJSON(value?: DatasetOptionsMergePatch | null): any {
    ...
    switch (value['type']) {
        ...
        case 'merge':
            return DatasetOptionsMergeMergePatchToJSON(value);
        case 'mysql':
