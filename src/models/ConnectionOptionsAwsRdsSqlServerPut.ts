...
export function ConnectionOptionsAwsRdsSqlServerPutFromJSON(json: any): ConnectionOptionsAwsRdsSqlServerPut {
    return ConnectionOptionsAwsRdsSqlServerPutFromJSONTyped(json, false);
}

export function ConnectionOptionsAwsRdsSqlServerPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsAwsRdsSqlServerPut {
...
export function ConnectionOptionsAwsRdsSqlServerPutToJSON(value?: ConnectionOptionsAwsRdsSqlServerPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
