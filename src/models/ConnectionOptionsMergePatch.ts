...
import {
    ...
    ConnectionOptionsMergeMergePatchFromJSON,
    ConnectionOptionsMergeMergePatchFromJSONTyped,
    ConnectionOptionsMergeMergePatchToJSON,
} from './ConnectionOptionsMergeMergePatch';
import {
...
export function ConnectionOptionsMergePatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsMergePatch {
    ...
    switch (json['type']) {
        ...
        case 'merge':
            return {...ConnectionOptionsMergeMergePatchFromJSONTyped(json, true), type: 'merge'};
        case 'mysql':
...
export function ConnectionOptionsMergePatchToJSON(value?: ConnectionOptionsMergePatch | null): any {
    ...
    switch (value['type']) {
        ...
        case 'merge':
            return ConnectionOptionsMergeMergePatchToJSON(value);
        case 'mysql':
