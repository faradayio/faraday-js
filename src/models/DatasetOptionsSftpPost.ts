...
export function DatasetOptionsSftpPostFromJSON(json: any): DatasetOptionsSftpPost {
    return DatasetOptionsSftpPostFromJSONTyped(json, false);
}

export function DatasetOptionsSftpPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsSftpPost {
...
export function DatasetOptionsSftpPostToJSON(value?: DatasetOptionsSftpPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
