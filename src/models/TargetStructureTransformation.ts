...
export function TargetStructureTransformationFromJSON(json: any): TargetStructureTransformation {
    return TargetStructureTransformationFromJSONTyped(json, false);
}

export function TargetStructureTransformationFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetStructureTransformation {
    ...
    return {
        ...
        'aggregation_criteria': !exists(json, 'aggregation_criteria') ? undefined : json['aggregation_criteria'],
        'is_identity_col': !exists(json, 'is_identity_col') ? undefined : json['is_identity_col'],
        'output_col': json['output_col'],
        'scope_col': json['scope_col'],
    };
}

export function TargetStructureTransformationToJSON(value?: TargetStructureTransformation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
