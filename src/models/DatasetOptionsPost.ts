...
import {
    ...
    DatasetOptionsMergePostFromJSON,
    DatasetOptionsMergePostFromJSONTyped,
    DatasetOptionsMergePostToJSON,
} from './DatasetOptionsMergePost';
import {
...
export function DatasetOptionsPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsPost {
    ...
    switch (json['type']) {
        ...
        case 'merge':
            return {...DatasetOptionsMergePostFromJSONTyped(json, true), type: 'merge'};
        case 'mysql':
...
export function DatasetOptionsPostToJSON(value?: DatasetOptionsPost | null): any {
    ...
    switch (value['type']) {
        ...
        case 'merge':
            return DatasetOptionsMergePostToJSON(value);
        case 'mysql':
