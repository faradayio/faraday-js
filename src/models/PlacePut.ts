...
export function PlacePutFromJSON(json: any): PlacePut {
    return PlacePutFromJSONTyped(json, false);
}

export function PlacePutFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlacePut {
...
export function PlacePutToJSON(value?: PlacePut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
