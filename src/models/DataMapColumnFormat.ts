...
export enum DataMapColumnFormat {
    ...
    MDYySlash = 'm_d_yy_slash',
    MDYyyySlash = 'm_d_yyyy_slash',
    MDYyDash = 'm_d_yy_dash',
    MDYyyyDash = 'm_d_yyyy_dash',
    MmDdYySlash = 'mm_dd_yy_slash',
    MmDdYyyySlash = 'mm_dd_yyyy_slash',
    MmDdYyDash = 'mm_dd_yy_dash',
    MmDdYyyyDash = 'mm_dd_yyyy_dash',
    YyyyMDSlash = 'yyyy_m_d_slash',
    YyMDSlash = 'yy_m_d_slash',
    YyyyMDDash = 'yyyy_m_d_dash',
    YyMDDash = 'yy_m_d_dash',
