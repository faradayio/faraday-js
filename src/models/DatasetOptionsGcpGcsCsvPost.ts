...
export function DatasetOptionsGcpGcsCsvPostFromJSON(json: any): DatasetOptionsGcpGcsCsvPost {
    return DatasetOptionsGcpGcsCsvPostFromJSONTyped(json, false);
}

export function DatasetOptionsGcpGcsCsvPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsGcpGcsCsvPost {
...
export function DatasetOptionsGcpGcsCsvPostToJSON(value?: DatasetOptionsGcpGcsCsvPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
