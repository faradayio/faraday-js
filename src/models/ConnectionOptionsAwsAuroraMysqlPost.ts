...
export function ConnectionOptionsAwsAuroraMysqlPostFromJSON(json: any): ConnectionOptionsAwsAuroraMysqlPost {
    return ConnectionOptionsAwsAuroraMysqlPostFromJSONTyped(json, false);
}

export function ConnectionOptionsAwsAuroraMysqlPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsAwsAuroraMysqlPost {
...
export function ConnectionOptionsAwsAuroraMysqlPostToJSON(value?: ConnectionOptionsAwsAuroraMysqlPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
