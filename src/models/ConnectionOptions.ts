...
import {
    ...
    ConnectionOptionsMergeFromJSON,
    ConnectionOptionsMergeFromJSONTyped,
    ConnectionOptionsMergeToJSON,
} from './ConnectionOptionsMerge';
import {
...
export function ConnectionOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptions {
    ...
    switch (json['type']) {
        ...
        case 'merge':
            return {...ConnectionOptionsMergeFromJSONTyped(json, true), type: 'merge'};
        case 'mysql':
...
export function ConnectionOptionsToJSON(value?: ConnectionOptions | null): any {
    ...
    switch (value['type']) {
        ...
        case 'merge':
            return ConnectionOptionsMergeToJSON(value);
        case 'mysql':
