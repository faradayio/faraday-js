...
export function DataMapColumnPutFromJSON(json: any): DataMapColumnPut {
    return DataMapColumnPutFromJSONTyped(json, false);
}

export function DataMapColumnPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataMapColumnPut {
...
export function DataMapColumnPutToJSON(value?: DataMapColumnPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
