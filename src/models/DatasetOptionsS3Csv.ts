...
export function DatasetOptionsS3CsvFromJSON(json: any): DatasetOptionsS3Csv {
    return DatasetOptionsS3CsvFromJSONTyped(json, false);
}

export function DatasetOptionsS3CsvFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsS3Csv {
...
export function DatasetOptionsS3CsvToJSON(value?: DatasetOptionsS3Csv | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
