...
export declare function DatasetOptionsHostedCsvFromJSON(json: any): DatasetOptionsHostedCsv;
export declare function DatasetOptionsHostedCsvFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsHostedCsv;
export declare function DatasetOptionsHostedCsvToJSON(value?: DatasetOptionsHostedCsv | null): any;
