...
export declare function TargetFilterFromJSON(json: any): TargetFilter;
export declare function TargetFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetFilter;
export declare function TargetFilterToJSON(value?: TargetFilter | null): any;
