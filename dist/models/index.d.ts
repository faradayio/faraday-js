...
export interface DatasetIngressLogMetrics {
    /**
     * Rows allowed after CCPA filtering
     * @type {number}
    ...
    /**
     * Individual records eligible for enrichment
     * @type {number}
     * @memberof DatasetIngressLogMetrics
     */
    enrichable_people_count?: number;
    /**
     * Residence-only records eligible for enrichment
     * @type {number}
     * @memberof DatasetIngressLogMetrics
     */
    enrichable_residence_count?: number;
    /**
     * Rows eligible for enrichment
     * @type {number}
     * @memberof DatasetIngressLogMetrics
     */
    ...
    /**
     * Unique people eligible for individual enrichment
     * @type {number}
     * @memberof DatasetIngressLogMetrics
     */
    enrichable_unique_people_count?: number;
    /**
