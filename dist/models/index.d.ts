...
export interface PersonaSet {
    ...
    /**
     * The actual clustering inputs the built persona model used, including any derived reductions.
...
* @enum {string}
*/
export declare enum PersonaSetClusteringInputKindEnum {
    Field = "field",
    Attribute = "attribute"
} /**
* @export
* @enum {string}
*/
export declare enum PersonaSetClusteringInputReductionTypeEnum {
    Identity = "identity",
    Mode = "mode",
    Avg = "avg",
    AvgDate = "avg_date",
