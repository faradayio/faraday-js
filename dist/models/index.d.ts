...
export declare enum ModelingField {
    FigActvtyNumPurchaseQuintile = "fig/actvty_num_purchase_quintile",
    FigActvtyTtlDollarsQuintile = "fig/actvty_ttl_dollars_quintile",
    FigAge = "fig/age",
    FigAntiques = "fig/antiques",
    FigBooksMagazines = "fig/books_magazines",
    FigCharitableDonations = "fig/charitable_donations",
    FigDieting = "fig/dieting",
    FigEducation = "fig/education",
    FigFavm = "fig/favm",
    FigFrequentRemodeler = "fig/frequent_remodeler",
    FigGardener = "fig/gardener",
    FigGender = "fig/gender",
    FigHealthConscious = "fig/health_conscious",
    FigHomeownerStatus = "fig/homeowner_status",
    FigHouseholdIncome = "fig/household_income",
    FigHouseholdSize = "fig/household_size",
    FigLengthOfResidence = "fig/length_of_residence",
    FigLifeSportsSportsAll = "fig/life_sports_sports_all",
    FigLivingArea = "fig/living_area",
    FigMaritalStatus = "fig/marital_status",
    FigMusic = "fig/music",
    FigNetWorth = "fig/net_worth",
    FigPercentEquity = "fig/percent_equity",
    FigPetAny = "fig/pet_any",
    FigPurchChanInternet = "fig/purch_chan_internet",
    FigShoppingStyles = "fig/shopping_styles",
    FigTravel = "fig/travel",
    FigHousingDensity = "fig/housing_density",
    FigValueScoreAll = "fig/value_score_all",
    FigYearBuilt = "fig/year_built",
    FigChildrenInHousehold = "fig/children_in_household",
    GeneralProduct = "general_product",
    ProductTypeBracelet = "product_type_bracelet",
    ProductTypeEarring = "product_type_earring",
    ProductTypeNecklace = "product_type_necklace",
    ProductTypeRing = "product_type_ring",
    ProductFine = "product_fine",
    RollupDiscounts = "rollup_discounts",
    RollupEcom = "rollup_ecom",
    RollupFineOrderCount = "rollup_fine_order_count",
    RollupRetail = "rollup_retail",
    RollupSpend = "rollup_spend"
}
/**
