...
export declare function TargetOptionsIterablePutFromJSON(json: any): TargetOptionsIterablePut;
export declare function TargetOptionsIterablePutFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetOptionsIterablePut;
export declare function TargetOptionsIterablePutToJSON(value?: TargetOptionsIterablePut | null): any;
