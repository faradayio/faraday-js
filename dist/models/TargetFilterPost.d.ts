...
export declare function TargetFilterPostFromJSON(json: any): TargetFilterPost;
export declare function TargetFilterPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetFilterPost;
export declare function TargetFilterPostToJSON(value?: TargetFilterPost | null): any;
