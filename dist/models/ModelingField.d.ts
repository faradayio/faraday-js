...
export declare function ModelingFieldFromJSON(json: any): ModelingField;
export declare function ModelingFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelingField;
export declare function ModelingFieldToJSON(value?: ModelingField | null): any;
