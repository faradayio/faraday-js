 ...
 */
import { TargetModesAggregatedPut } from './TargetModesAggregatedPut';
import { TargetModesHashedPut } from './TargetModesHashedPut';
import { TargetModesIdentifiedPut } from './TargetModesIdentifiedPut';
import { TargetModesReferencedPut } from './TargetModesReferencedPut';
/**
 * @type TargetModesPut
...
export declare function TargetModesPutFromJSON(json: any): TargetModesPut;
export declare function TargetModesPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetModesPut;
export declare function TargetModesPutToJSON(value?: TargetModesPut | null): any;
