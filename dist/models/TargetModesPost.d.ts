 ...
 */
import { TargetModesAggregatedPost } from './TargetModesAggregatedPost';
import { TargetModesHashedPost } from './TargetModesHashedPost';
import { TargetModesIdentifiedPost } from './TargetModesIdentifiedPost';
import { TargetModesReferencedPost } from './TargetModesReferencedPost';
/**
...
export declare function TargetModesPostFromJSON(json: any): TargetModesPost;
export declare function TargetModesPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetModesPost;
export declare function TargetModesPostToJSON(value?: TargetModesPost | null): any;
