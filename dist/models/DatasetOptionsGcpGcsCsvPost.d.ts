...
export declare function DatasetOptionsGcpGcsCsvPostFromJSON(json: any): DatasetOptionsGcpGcsCsvPost;
export declare function DatasetOptionsGcpGcsCsvPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsGcpGcsCsvPost;
export declare function DatasetOptionsGcpGcsCsvPostToJSON(value?: DatasetOptionsGcpGcsCsvPost | null): any;
