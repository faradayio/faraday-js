...
export declare function DatasetOptionsHostedCsvMergePatchFromJSON(json: any): DatasetOptionsHostedCsvMergePatch;
export declare function DatasetOptionsHostedCsvMergePatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsHostedCsvMergePatch;
export declare function DatasetOptionsHostedCsvMergePatchToJSON(value?: DatasetOptionsHostedCsvMergePatch | null): any;
