...
exports.TargetModesAggregatedToJSON = exports.TargetModesAggregatedFromJSONTyped = exports.TargetModesAggregatedFromJSON = void 0;
...
function TargetModesAggregatedFromJSON(json) {
    return TargetModesAggregatedFromJSONTyped(json, false);
}
exports.TargetModesAggregatedFromJSON = TargetModesAggregatedFromJSON;
function TargetModesAggregatedFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TargetModesAggregatedFromJSONTyped = TargetModesAggregatedFromJSONTyped;
function TargetModesAggregatedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TargetModesAggregatedToJSON = TargetModesAggregatedToJSON;
