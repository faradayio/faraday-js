...
export declare function TargetTransformPresetHashedFromJSON(json: any): TargetTransformPresetHashed;
export declare function TargetTransformPresetHashedFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetTransformPresetHashed;
export declare function TargetTransformPresetHashedToJSON(value?: TargetTransformPresetHashed | null): any;
