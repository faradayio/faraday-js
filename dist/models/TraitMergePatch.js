...
exports.TraitMergePatchToJSON = exports.TraitMergePatchFromJSONTyped = exports.TraitMergePatchFromJSON = void 0;
const runtime_1 = require("../runtime");
const TraitStatisticalType_1 = require("./TraitStatisticalType");
function TraitMergePatchFromJSON(json) {
    return TraitMergePatchFromJSONTyped(json, false);
}
exports.TraitMergePatchFromJSON = TraitMergePatchFromJSON;
function TraitMergePatchFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TraitMergePatchFromJSONTyped = TraitMergePatchFromJSONTyped;
function TraitMergePatchToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TraitMergePatchToJSON = TraitMergePatchToJSON;
