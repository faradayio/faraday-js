...
exports.TargetModesAggregatedPutToJSON = exports.TargetModesAggregatedPutFromJSONTyped = exports.TargetModesAggregatedPutFromJSON = void 0;
...
function TargetModesAggregatedPutFromJSON(json) {
    return TargetModesAggregatedPutFromJSONTyped(json, false);
}
exports.TargetModesAggregatedPutFromJSON = TargetModesAggregatedPutFromJSON;
function TargetModesAggregatedPutFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TargetModesAggregatedPutFromJSONTyped = TargetModesAggregatedPutFromJSONTyped;
function TargetModesAggregatedPutToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TargetModesAggregatedPutToJSON = TargetModesAggregatedPutToJSON;
