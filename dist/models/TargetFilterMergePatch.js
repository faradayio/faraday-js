...
function TargetFilterMergePatchFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'recommender_rank': !runtime_1.exists(json, 'recommender_rank') ? undefined : (json['recommender_rank'] === null ? null : json['recommender_rank'].map(TargetFilterRecommenderRankConditions_1.TargetFilterRecommenderRankConditionsFromJSON)),
        'recommender_uncalibrated_probability': !runtime_1.exists(json, 'recommender_uncalibrated_probability') ? undefined : (json['recommender_uncalibrated_probability'] === null ? null : json['recommender_uncalibrated_probability'].map(TargetFilterRecommenderUncalibratedProbabilityConditions_1.TargetFilterRecommenderUncalibratedProbabilityConditionsFromJSON)),
...
function TargetFilterMergePatchToJSON(value) {
    ...
    return {
        ...
        'recommender_rank': value.recommender_rank === undefined ? undefined : (value.recommender_rank === null ? null : value.recommender_rank.map(TargetFilterRecommenderRankConditions_1.TargetFilterRecommenderRankConditionsToJSON)),
        'recommender_uncalibrated_probability': value.recommender_uncalibrated_probability === undefined ? undefined : (value.recommender_uncalibrated_probability === null ? null : value.recommender_uncalibrated_probability.map(TargetFilterRecommenderUncalibratedProbabilityConditions_1.TargetFilterRecommenderUncalibratedProbabilityConditionsToJSON)),
