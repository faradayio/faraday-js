...
export declare function PersonaDetailsFromJSON(json: any): PersonaDetails;
export declare function PersonaDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonaDetails;
export declare function PersonaDetailsToJSON(value?: PersonaDetails | null): any;
