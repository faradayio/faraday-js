...
exports.ConnectionOptionsRedshiftMergePatchToJSON = exports.ConnectionOptionsRedshiftMergePatchFromJSONTyped = exports.ConnectionOptionsRedshiftMergePatchFromJSON = void 0;
const runtime_1 = require("../runtime");
function ConnectionOptionsRedshiftMergePatchFromJSON(json) {
    return ConnectionOptionsRedshiftMergePatchFromJSONTyped(json, false);
}
exports.ConnectionOptionsRedshiftMergePatchFromJSON = ConnectionOptionsRedshiftMergePatchFromJSON;
function ConnectionOptionsRedshiftMergePatchFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ConnectionOptionsRedshiftMergePatchFromJSONTyped = ConnectionOptionsRedshiftMergePatchFromJSONTyped;
function ConnectionOptionsRedshiftMergePatchToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ConnectionOptionsRedshiftMergePatchToJSON = ConnectionOptionsRedshiftMergePatchToJSON;
