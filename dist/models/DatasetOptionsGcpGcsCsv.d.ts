...
export declare function DatasetOptionsGcpGcsCsvFromJSON(json: any): DatasetOptionsGcpGcsCsv;
export declare function DatasetOptionsGcpGcsCsvFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsGcpGcsCsv;
export declare function DatasetOptionsGcpGcsCsvToJSON(value?: DatasetOptionsGcpGcsCsv | null): any;
