...
exports.IdentitySetMergePatchToJSON = exports.IdentitySetMergePatchFromJSONTyped = exports.IdentitySetMergePatchFromJSON = void 0;
const runtime_1 = require("../runtime");
function IdentitySetMergePatchFromJSON(json) {
    return IdentitySetMergePatchFromJSONTyped(json, false);
}
exports.IdentitySetMergePatchFromJSON = IdentitySetMergePatchFromJSON;
function IdentitySetMergePatchFromJSONTyped(json, ignoreDiscriminator) {
...
exports.IdentitySetMergePatchFromJSONTyped = IdentitySetMergePatchFromJSONTyped;
function IdentitySetMergePatchToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.IdentitySetMergePatchToJSON = IdentitySetMergePatchToJSON;
