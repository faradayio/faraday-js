 ...
 */
import { TargetFilterMergePatch } from './TargetFilterMergePatch';
import { TargetLimitMergePatch } from './TargetLimitMergePatch';
import { TargetModesMergePatch } from './TargetModesMergePatch';
import { TargetOptionsMergePatch } from './TargetOptionsMergePatch';
...
export declare function TargetMergePatchFromJSON(json: any): TargetMergePatch;
export declare function TargetMergePatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetMergePatch;
export declare function TargetMergePatchToJSON(value?: TargetMergePatch | null): any;
