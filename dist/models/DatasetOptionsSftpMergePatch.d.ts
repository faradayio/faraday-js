...
export declare function DatasetOptionsSftpMergePatchFromJSON(json: any): DatasetOptionsSftpMergePatch;
export declare function DatasetOptionsSftpMergePatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): DatasetOptionsSftpMergePatch;
export declare function DatasetOptionsSftpMergePatchToJSON(value?: DatasetOptionsSftpMergePatch | null): any;
