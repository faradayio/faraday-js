...
* @enum {string}
*/
var AttributeSourceConfigPrecisionEnum;
(function (AttributeSourceConfigPrecisionEnum) {
    AttributeSourceConfigPrecisionEnum["Person"] = "person";
    AttributeSourceConfigPrecisionEnum["Address"] = "address";
    AttributeSourceConfigPrecisionEnum["Postcode"] = "postcode";
})(AttributeSourceConfigPrecisionEnum = exports.AttributeSourceConfigPrecisionEnum || (exports.AttributeSourceConfigPrecisionEnum = {}));
/**
* @export
* @enum {string}
*/
