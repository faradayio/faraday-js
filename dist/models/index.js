...
(function (ModelingField) {
    ModelingField["FigActvtyNumPurchaseQuintile"] = "fig/actvty_num_purchase_quintile";
    ModelingField["FigActvtyTtlDollarsQuintile"] = "fig/actvty_ttl_dollars_quintile";
    ModelingField["FigAge"] = "fig/age";
    ModelingField["FigAntiques"] = "fig/antiques";
    ModelingField["FigBooksMagazines"] = "fig/books_magazines";
    ModelingField["FigCharitableDonations"] = "fig/charitable_donations";
    ModelingField["FigDieting"] = "fig/dieting";
    ModelingField["FigEducation"] = "fig/education";
    ModelingField["FigFavm"] = "fig/favm";
    ModelingField["FigFrequentRemodeler"] = "fig/frequent_remodeler";
    ModelingField["FigGardener"] = "fig/gardener";
    ModelingField["FigGender"] = "fig/gender";
    ModelingField["FigHealthConscious"] = "fig/health_conscious";
    ModelingField["FigHomeownerStatus"] = "fig/homeowner_status";
    ModelingField["FigHouseholdIncome"] = "fig/household_income";
    ModelingField["FigHouseholdSize"] = "fig/household_size";
    ModelingField["FigLengthOfResidence"] = "fig/length_of_residence";
    ModelingField["FigLifeSportsSportsAll"] = "fig/life_sports_sports_all";
    ModelingField["FigLivingArea"] = "fig/living_area";
    ModelingField["FigMaritalStatus"] = "fig/marital_status";
    ModelingField["FigMusic"] = "fig/music";
    ModelingField["FigNetWorth"] = "fig/net_worth";
    ModelingField["FigPercentEquity"] = "fig/percent_equity";
    ModelingField["FigPetAny"] = "fig/pet_any";
    ModelingField["FigPurchChanInternet"] = "fig/purch_chan_internet";
    ModelingField["FigShoppingStyles"] = "fig/shopping_styles";
    ModelingField["FigTravel"] = "fig/travel";
    ModelingField["FigHousingDensity"] = "fig/housing_density";
    ModelingField["FigValueScoreAll"] = "fig/value_score_all";
    ModelingField["FigYearBuilt"] = "fig/year_built";
    ModelingField["FigChildrenInHousehold"] = "fig/children_in_household";
    ModelingField["GeneralProduct"] = "general_product";
    ModelingField["ProductTypeBracelet"] = "product_type_bracelet";
    ModelingField["ProductTypeEarring"] = "product_type_earring";
    ModelingField["ProductTypeNecklace"] = "product_type_necklace";
    ModelingField["ProductTypeRing"] = "product_type_ring";
    ModelingField["ProductFine"] = "product_fine";
    ModelingField["RollupDiscounts"] = "rollup_discounts";
    ModelingField["RollupEcom"] = "rollup_ecom";
    ModelingField["RollupFineOrderCount"] = "rollup_fine_order_count";
    ModelingField["RollupRetail"] = "rollup_retail";
    ModelingField["RollupSpend"] = "rollup_spend";
