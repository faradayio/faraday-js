...
* @enum {string}
*/
var PersonaSetClusteringInputKindEnum;
(function (PersonaSetClusteringInputKindEnum) {
    PersonaSetClusteringInputKindEnum["Field"] = "field";
    PersonaSetClusteringInputKindEnum["Attribute"] = "attribute";
})(PersonaSetClusteringInputKindEnum = exports.PersonaSetClusteringInputKindEnum || (exports.PersonaSetClusteringInputKindEnum = {})); /**
* @export
* @enum {string}
*/
var PersonaSetClusteringInputReductionTypeEnum;
(function (PersonaSetClusteringInputReductionTypeEnum) {
    PersonaSetClusteringInputReductionTypeEnum["Identity"] = "identity";
    PersonaSetClusteringInputReductionTypeEnum["Mode"] = "mode";
    PersonaSetClusteringInputReductionTypeEnum["Avg"] = "avg";
    PersonaSetClusteringInputReductionTypeEnum["AvgDate"] = "avg_date";
    PersonaSetClusteringInputReductionTypeEnum["FamilyInduction"] = "family_induction";
})(PersonaSetClusteringInputReductionTypeEnum = exports.PersonaSetClusteringInputReductionTypeEnum || (exports.PersonaSetClusteringInputReductionTypeEnum = {}));
/**
