...
export declare function DataMapColumnFormatFromJSON(json: any): DataMapColumnFormat;
export declare function DataMapColumnFormatFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataMapColumnFormat;
export declare function DataMapColumnFormatToJSON(value?: DataMapColumnFormat | null): any;
