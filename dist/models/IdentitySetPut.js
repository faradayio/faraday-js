...
exports.IdentitySetPutToJSON = exports.IdentitySetPutFromJSONTyped = exports.IdentitySetPutFromJSON = void 0;
const runtime_1 = require("../runtime");
function IdentitySetPutFromJSON(json) {
    return IdentitySetPutFromJSONTyped(json, false);
}
exports.IdentitySetPutFromJSON = IdentitySetPutFromJSON;
function IdentitySetPutFromJSONTyped(json, ignoreDiscriminator) {
...
exports.IdentitySetPutFromJSONTyped = IdentitySetPutFromJSONTyped;
function IdentitySetPutToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.IdentitySetPutToJSON = IdentitySetPutToJSON;
