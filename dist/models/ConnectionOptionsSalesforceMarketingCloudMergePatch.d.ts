...
export declare function ConnectionOptionsSalesforceMarketingCloudMergePatchFromJSON(json: any): ConnectionOptionsSalesforceMarketingCloudMergePatch;
export declare function ConnectionOptionsSalesforceMarketingCloudMergePatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsSalesforceMarketingCloudMergePatch;
export declare function ConnectionOptionsSalesforceMarketingCloudMergePatchToJSON(value?: ConnectionOptionsSalesforceMarketingCloudMergePatch | null): any;
