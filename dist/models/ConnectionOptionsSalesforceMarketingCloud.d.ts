...
export declare function ConnectionOptionsSalesforceMarketingCloudFromJSON(json: any): ConnectionOptionsSalesforceMarketingCloud;
export declare function ConnectionOptionsSalesforceMarketingCloudFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionOptionsSalesforceMarketingCloud;
export declare function ConnectionOptionsSalesforceMarketingCloudToJSON(value?: ConnectionOptionsSalesforceMarketingCloud | null): any;
