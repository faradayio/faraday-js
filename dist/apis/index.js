...
const AtlasesApi_1 = require("./AtlasesApi");
...
const EnrichmentJobsApi_1 = require("./EnrichmentJobsApi");
const EnrichmentsApi_1 = require("./EnrichmentsApi");
...
const KnowledgebaseApi_1 = require("./KnowledgebaseApi");
...
class FaradayClient {
    constructor(configuration) {
        ...
        this.atlases = new AtlasesApi_1.AtlasesApi(configuration);
        ...
        this.enrichmentJobs = new EnrichmentJobsApi_1.EnrichmentJobsApi(configuration);
        this.enrichments = new EnrichmentsApi_1.EnrichmentsApi(configuration);
        ...
        this.locations = new LocationsApi_1.LocationsApi(configuration);
