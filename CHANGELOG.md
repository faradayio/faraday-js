...
- POST/PATCH targets - include_identifiers - specify which identity columns are returned in your referenced target. Your account must have permission to use this feature.
