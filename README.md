...
> **⚠️ Deprecated and no longer maintained.** This package is no longer
> published or updated. Generate a type-safe client from Faraday's OpenAPI spec
> with [`openapi-fetch`](https://openapi-ts.dev/openapi-fetch/) instead — see
